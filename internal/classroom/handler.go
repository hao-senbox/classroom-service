...
func (h *ClassroomHandler) GetClassroomsByOrg(c *gin.Context) {
	...
	classrooms, err := h.ClassroomService.GetClassroomsByOrg(ctx)
...
func (h *ClassroomHandler) GetClassroomByIDTemplate(c *gin.Context) {
	...
	classroom, err := h.ClassroomService.GetClassroomByIDTemplate(ctx, id, termID)
...
func (h *ClassroomHandler) GetClassroomTemplateByTermIDAndStudentID(c *gin.Context) {
	...
	if studentID == "" {
		helper.SendError(c, http.StatusBadRequest, errors.New("student_id is required"), "INVALID_REQUEST")
		return
	}
	...
	classroomTemplate, err := h.ClassroomService.GetClassroomTemplateByTermIDAndStudentID(ctx, studentID, termID)
...
func (h *ClassroomHandler) GetTeacherTemplateByTermIDAndStudentID(c *gin.Context) {
	...
	classroomTemplate, err := h.ClassroomService.GetTeacherTemplateByTermIDAndStudentID(ctx, studentID, termID)
